## Migration Guide: Spring gRPC 1.0.x to 1.1.2-SNAPSHOT

This is an autommatically generated migration giode specificially for the samples in this project. There is a generic hand written guide that might also help you migrate in a [Wiki page](https://github.com/spring-projects/spring-grpc/wiki/Spring-gRPC-1.1-Migration-Guide). The headline change is that Spring gRPC 1.1.2-SNAPSHOT autoconfiguration ships as part of Spring Boot 4.1.0. The starter artifacts have moved from the `org.springframework.grpc` group into Spring Boot itself.
...
| 1.0.x artifact | 1.1.2-SNAPSHOT artifact |
|---|---|
...
| 1.0.x property | 1.1.2-SNAPSHOT property |
|---|---|
